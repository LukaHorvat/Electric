...
namespace FireflyGL.Utility
{
	...
	class MutableTuple<T1, T2, T3, T4, T5>
	{
		public T1 First; public T2 Second; public T3 Third;
	...
	class MutableTuple<T1, T2, T3, T4, T5, T6>
	{
		public T1 First; public T2 Second; public T3 Third;
	...
	class MutableTuple<T1, T2, T3, T4, T5, T6, T7>
	{
		public T1 First; public T2 Second; public T3 Third;
		public T4 Fourth; public T5 Fifth; public T6 Sixth;
		public T7 Seventh;
	...
	class MutableTuple<T1, T2, T3, T4, T5, T6, T7, T8>
	{
		public T1 First; public T2 Second; public T3 Third;
		public T4 Fourth; public T5 Fifth; public T6 Sixth;
	...
	class MutableTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9>
	{
		public T1 First; public T2 Second; public T3 Third;
		public T4 Fourth; public T5 Fifth; public T6 Sixth;
	...
	class MutableTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
	{
		public T1 First; public T2 Second; public T3 Third;
		public T4 Fourth; public T5 Fifth; public T6 Sixth;
		public T7 Seventh; public T8 Eighth; public T9 Ninth;
	...
	class MutableTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
	{
		public T1 First; public T2 Second; public T3 Third;
		public T4 Fourth; public T5 Fifth; public T6 Sixth;
		public T7 Seventh; public T8 Eighth; public T9 Ninth;
	...
	class MutableTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>
	{
		public T1 First; public T2 Second; public T3 Third;
		public T4 Fourth; public T5 Fifth; public T6 Sixth;
		public T7 Seventh; public T8 Eighth; public T9 Ninth;
